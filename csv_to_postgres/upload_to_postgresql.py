    ...
    with pd.read_csv(file_path, chunksize=chunksize, low_memory=False) as reader:
        for i, chunk in enumerate(reader):
            ...
            if first_chunk:
                ...
                chunk.to_sql('raw_flights_2015', engine, if_exists='replace', index=False)
                first_chunk = False
            else:
                # Appends to the table
                chunk.to_sql('raw_flights_2015', engine, if_exists='append', index=False)
